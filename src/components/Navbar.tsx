    ...
    return (
        <div className="sticky z-10 top-0 flex items-center px-4 sm:px-8 py-3 sm:py-2 justify-between border-b border-slate-300 bg-[#e6e8ea]">
            ...
            <div className="hidden sm:flex items-center gap-6 ">
                    <Link className="flex items-center gap-2" href="https://github.com/Judiciousmurich/designer-store-nextjs" target="_blank"><FaGithub /> Github</Link>
                {/* Hover Card */}
                <HoverCard>
                    <HoverCardTrigger>
                    ...
                    <HoverCardContent>
                        <p>Youre logged in as <span className="underline">judicious</span></p>
                        <p>Orders</p>
                        <p>Settings</p>
                        <hr />
